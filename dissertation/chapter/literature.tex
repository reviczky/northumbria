...
% Relevancy
This section is looking at the existing models that are available and used in the industry that can help analysing the motion patterns of connected cars. Most of the work has been done on network traffic log analysis and this will be looked at, more specifically, how to adapt the interpretation of sensor readings into the algorithm. \par
...
% Total number of words per section: 294/400
...
This chapter has looked in-depth at the literature available in regards to the papers research question on proactive threat detection methods with the use case of connected cars and has critically evaluated the content. In the next chapter the design of the project, including the experiments and the case study can be found. \par
...
% Total number of words: 2092/3000
