...
% Total number of words per section: 298/250
...
The full plotting and results for the scenarios of the connected cars can be found in the Appendix part of the paper (see \in{Chart}[chart:rstan] and \in{Chart}[chart:deviation]). \par
...
% Total number of words per section: 284/250
...
\startitemize[joinedupe,nowhite]
...
% Total number of words: 1951/2000
