...
% Total number of words per section: 182/200
...
% following technique / The following specific data is showing an example extract of the routes: / sample:
...
% Total number of words per section: 187/200
