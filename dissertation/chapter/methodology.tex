...
In this chapter it is going to be explained what methods have been used and how the research has been carried out. It gives an overview on the research and its design coupled with explanation on how the data analysis has been conducted. A comprehensive list of experiments that have been conducted will conclude this chapter. \par
...
{\bf
\startquotation
How can cyber resilience be improved proactively to predict cyber threats in real time on connected cars to counter cyber-attacks?
\stopquotation
}
\stopsection
...
% Total number of words: 1105/1000
