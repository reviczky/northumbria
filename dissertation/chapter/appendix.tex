...
\startplacefigure[location=place,reference={chart:rstan},title={RStan Bayesian Estimation Graph},style={cap}]
...
\startplacetable[location=place,reference={table:ads},title={Table ADS-B},style={cap}]
