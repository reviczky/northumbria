...
\startplacefigure[location=place,reference={picture:1},title={Connected Car with \\ Sensors (Tesla Model X)},style={cap}]
...
\startplacetable[location=place,reference={table:ads},title={Automatic \\ Dependent Surveillance: \\ Sample Log},style={cap}]
...
\startplacefigure[location=place,reference={diagram:1},title={Anomality Threshold},style={cap}]
\startframed[frame=off,strut=no,offset=0mm]
\startSTEPchart
\cell {CPS Systems}
