...
The papers contribution to the community is measured against the current peer-reviewed papers on the topic of cyber threats against connected cars. \par
These are the 3 papers from the community: \par
...
\stopitemize
The main paper being the first one. \par
