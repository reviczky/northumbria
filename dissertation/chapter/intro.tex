...
\sym{»} To propose a live warning alarm system (similar to the ground proximity alarm in aeroplanes) and a live tracking site (see \goto{flightradar24.com}[url(https://www.flightradar24.com/)]) to form a control centre against cyber attacks
\stopitemize
