...
\define\studentname{Adam Reviczky, Rafael Narezzi}
\define\studentnumber{14044980, 00000000}
...
\starttext
    ...
    \startalignment[middle]
        \blank[25mm]
        \WORD{Module 2 \blank[2*line] Network Security} \\
        \blank[2*line]
        \bf\documentname \\
        \blank[125mm]
    \stopalignment
    ...
    \startcolor[black] \tfx
        ...
        United Kingdom \\
        \blank[2*line]
        © 2015 Adam Reviczky, Rafael Narezzi \\
        ...
        Number of sides allowed for the Report (excluding the facing page): {\bf 10} \\
