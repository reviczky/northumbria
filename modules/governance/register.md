...
\startxtable[option=max,split=yes,header=repeat]
    ...
    \startxrow \startxcellgroup[align={middle,lohi}] \startxcell 2 \stopxcell \startxcell System Inaccessibility \stopxcell \stopxcellgroup \startxcell Reduce dependecy of service provider and cach data locally \stopxcell \startxcell 1. Multiple service provider \\ 2. Short-term software based solution \stopxcell \startxcellgroup[align={middle}] \startxcell Medium \stopxcell \startxcell Low \stopxcell \startxcell Transfer \stopxcell \stopxcellgroup \startxcell Vendor Management Division \stopxcell \startxcell[align={middle}] Q2 2016 \stopxcell \startxcell Monitor availability and service leves, compare peer solutions. \stopxcell \stopxrow
    \startxrow \startxcellgroup[align={middle,lohi}] \startxcell 3 \stopxcell \startxcell Third-Party System Glitch \stopxcell \stopxcellgroup \startxcell Leverage complementary solutions or buying insurace \stopxcell \startxcell 1. Available alternatives \\ 2. Insurance coverage \stopxcell \startxcellgroup[align={middle}] \startxcell High \stopxcell \startxcell Meidum \stopxcell \startxcell Transfer \stopxcell \stopxcellgroup \startxcell Vendor Management or Legal Division \stopxcell \startxcell[align={middle}] Q3 2016 \stopxcell \startxcell Monitor up-time and historical data, check insurance rates. \stopxcell \stopxrow
