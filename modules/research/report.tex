...
\starttext
    ...
    \startalignment[middle]
        \blank[25mm]
        \WORD{Module 5 \blank[2*line] \facultyname \blank[line] Module: \modulename \blank[line] Module tutor: \moduletutor \blank[line] \currentdate} \\
        \blank[2*line]
        \bf\documentname \\
        \blank[115mm]
    \stopalignment
    \startalignment[flushright]
        ...
        \tfb \studentname\ (\studentnumber) \hspace[arch]\ \blank[2*line] \bfb MSc in Cyber Security 2015/2016 \hspace[arch]\
    \stopalignment
    \stopstandardmakeup
